...
and areal aggregation. Examples use pre-computed results from **Niterói
(RJ)** (1,169 tracts, GPU) and **Belo Horizonte (MG)** (5,113 tracts,
GPU).
...
Use `keep` for additional objects:
...
This also includes source point geometries for overlay plots.
