...
each census tract and calibration bracket. Requires the weight matrix or
travel time matrix to be present in the result (use `keep = "weights"`
or `keep = "time_matrix"` when running the interpolation).
