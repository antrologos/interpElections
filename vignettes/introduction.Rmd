...
with **per-census-tract optimized decay parameters**, calibrated so that the
...
| Optimization | `optimize_alpha()` | Finds optimal per-census-tract decay parameters (CPU or GPU) |
