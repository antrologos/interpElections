...
decay parameter specific to census tract $i$. The "+1" offset prevents division
...
2. **One alpha per census tract.** Each tract gets its own decay parameter,
